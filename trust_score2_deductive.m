houseData = csvread('dataport-export(1).csv', 1,1);
...
allPt(ceil(i/214.00001),ceil(mod(i,214.00001))) = allPt3(i);
end
...
M=129;                                                           %Number of attacked meters is assigned to M
N=214;


dmin=1200;                                                        %Loading Delta min
dmax=1300;                                                       %Loading Delta max
dmin1=500;
dmax1=600;
...
for i=1:M
            ...
            d1=dmin1+(dmax1-dmin1).*rand(8640,1);
            for j=1:8640
%                 if mod(j,4)==1
%                     allPtadd1(j,i)=2;
%                 else
...
%                     allPtadd1(j,i)=2;
%                 else
                    allPtadd1(j,i)=allPtadd1(j,i)-d1(j,1);
            end
end
...
allPtadd(ceil(i/214.00001),ceil(mod(i,214.00001))) = allPtadd3(i);
end
